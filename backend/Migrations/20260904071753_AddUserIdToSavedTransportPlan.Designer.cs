...
namespace backend.Migrations
{
    ...
    [Migration("20260904071753_AddUserIdToSavedTransportPlan")]
    partial class AddUserIdToSavedTransportPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            PlanName = "My Sri Lanka Adventure"
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.TripBudget", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("LocalPriceMode")
                        .HasColumnType("boolean");

                    b.Property<decimal>("MaxBudgetLKR")
                        .HasColumnType("numeric");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LocalPriceMode = true,
                            MaxBudgetLKR = 50000m,
                            TripName = "Sri Lanka Explorer 2026"
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJJqfddjrnO8bzjlqAXQUREIllxArBj1E6GtKVuzv3qegONXfI54sKuPWaFY84XAGw==",
            ...
            modelBuilder.Entity("backend.Models.ExpenseItem", b =>
                {
                    b.HasOne("backend.Models.TripBudget", "TripBudget")
                        .WithMany("Expenses")
